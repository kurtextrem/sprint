...
return e&&!/\D/.test(i)&&(i+="px"),i}}(),e=function(t,n){return function(e){M(e.target).is(n)&&t.apply(e.target,arguments)}},i=function(t){var n=document.createElement("div"),e=/[\w:-]+/.exec(t)[0],i=k[e],r=t.trim()
...
var r=t.trim().split(" ")
return this.each(function(){f(this)||(this.sprintEventListeners={}),r.forEach(function(t){f(this)[t]||(f(this)[t]=[]),f(this)[t].push(i),this.addEventListener(t,i),p(t)&&this.addEventListener(u(t),i)},this)})}return Object.keys(t).forEach(function(n){this.on(n,t[n])},this),this},parent:function(t){return s.call(this,!0,!0,!1,t)},parents:function(t){return s.call(this,!0,!1,!1,t)},position:function(){var t={first:this.offset(),prt:this.parent().offset()}
